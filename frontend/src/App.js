...
function App() {
  ...
  return (
    ...
    align-content-center align-items-center mx-auto" style={{"width":"400px", 
    "backgroundColor":"white", "marginTop":"15px"}}>
      ...
      <div className="card-body">
        <h5 className="card text-white bg-dark mb-3">Add your task</h5>
          <span className="card-text">
            ...
            <input className="mb-2 form-control descriptionIn" onChange={
      ...
      <h6 className="card text-dark bg-warning py-1 mb-0">Copyright 2021, 
